...
<td><?=$data_siswa['alamat']?></td><td><?=$data_siswa['gender']?>
</td>
 <td><?=$data_siswa['username']?>
</td>
<td><?=$data_siswa['nama_kelas']?>
</td >
<td><a
href="ubah_siswa.php?id_kelas=<?=$data_siswa['id_kelas']?>"
class="btn btn-success">Ubah</a> | <a
href="hapus.php?id_kelas=<?=$data_siswa['id_kelas']?>"
